...
\begin{table}[]
    ...
    \begin{tabular}{c|c}
        법칙 이름&동치 관계\\
        \Xhline{3\arrayrulewidth}
        결합 법칙&\begin{tabular}{@{}c@{}}$(p\lor q)\lor r \equiv p \lor (q \lor r)$\\$(p\land q)\land r \equiv p \land (q \land r)$\end{tabular}\\
        \hline
        홀수 법칙&\begin{tabular}{@{}c@{}}$p\lor(p\land q) \equiv p$\\$p\land(p\lor q) \equiv p$\end{tabular}\\
        \hline
